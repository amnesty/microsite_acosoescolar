				...
				<div class="columna-contenido bcolor-grey-section">
					<div class="columna-contenido-inside">
						<div class="titulo-redes-container">
							<h1 class="black m-width">Decálogo para detectar el acoso escolar</h1>
...
<?php include ("includes/social_share_interior.php"); ?>
						...
						<img src="<?php echo URL_SITE; ?>images/decalogo-interior.png" alt="Decálogo para detectar el acoso escolar" class="decalogo-interior">
