...
<?php include ("includes/social_share_interior.php"); ?>
						...
						<div class="grid-video">
							<div class="video-responsive">
								<!--<iframe src="https://www.youtube.com/embed/zwu5FLKZ2_k" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>-->
								<div data-idyt="zwu5FLKZ2_k" data-category="Vídeos" data-action="Reproducir" data-label="Caso Eme" id="videocase"></div>
							</div>
						</div>
