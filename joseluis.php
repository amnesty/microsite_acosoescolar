...
$url_share_fb = 'http://bit.ly/2I08frS';
$url_share_tw = 'http://bit.ly/2I2VOM4';
$url_share_wh = 'http://bit.ly/2I0soOr';
				...
				<div class="columna-contenido bcolor-grey-section">
					<div class="columna-contenido-inside">
						<div class="titulo-redes-container">
							<h1 class="black m-width">José Luis</h1>
...
<?php include ("includes/social_share_interior.php"); ?>
						...
						<div class="grid-video">
							<div class="video-responsive">
								<!--<iframe src="https://www.youtube.com/embed/inCFHLoYqDM" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>-->
								<div data-idyt="inCFHLoYqDM" data-category="Vídeos" data-action="Reproducir" data-label="Caso José Luis" id="videocase"></div>
							</div>
						</div>				
